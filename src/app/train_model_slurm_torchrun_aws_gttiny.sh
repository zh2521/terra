...
#SBATCH --gpus-per-node=4                # requests 8 GPU on each node
#SBATCH --cpus-per-task=24               # allocates 48 CPU cores per task
#SBATCH --mem=512G                      # allocates 1024 GB of RAM memory per node
...
export RUN_NAME="gttiny_sampledcorpus_aws_19"
