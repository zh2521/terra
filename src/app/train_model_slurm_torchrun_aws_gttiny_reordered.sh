...
export RUN_NAME="gttiny_fullcorpus_reordered_aws_3"
...
srun torchrun \
    ...
    --backend nccl \
    --fname /home/ubuntu/sb75/nichejepa/configs/model/hst_corpus_90m/hst_corpus_90m_gttiny_reordered_aws.yaml