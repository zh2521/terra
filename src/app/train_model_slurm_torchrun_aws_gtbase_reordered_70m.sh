...
export RUN_NAME="gtbase_fullcorpus_reordered_70m_aws_3"
...
srun torchrun \
    ...
    --backend nccl \
    --fname /home/ubuntu/sb75/nichejepa/configs/model/hst_corpus_90m/hst_corpus_90m_gtbase_reordered_70m_aws.yaml