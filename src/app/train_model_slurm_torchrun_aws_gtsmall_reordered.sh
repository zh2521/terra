...
export RUN_NAME="gtsmall_fullcorpus_reordered_aws_4"
...
srun torchrun \
    ...
    --backend nccl \
    --fname /home/ubuntu/sb75/nichejepa/configs/model/hst_corpus_90m/hst_corpus_90m_gtsmall_reordered_aws.yaml